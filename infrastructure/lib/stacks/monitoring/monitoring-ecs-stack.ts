  ...
  private createEcsCluster(
    ...
    const efsCommands = fileSystem
      ? [
          ...
          "mkdir -p /mnt/efs",
          "",
          "# Get EFS mount target IP from DNS (more reliable than EFS helper)",
    ...
    autoScalingGroup.addUserData(
      ...
      "# Set Grafana directories to user 472 (grafana) with group 0 (root) for write access",
      "chown -R 472:0 /mnt/grafana-data /mnt/grafana-provisioning /mnt/grafana-dashboards",
      "chmod -R 755 /mnt/prometheus-data /mnt/prometheus-config",
      "# Make Grafana data directory group-writable so grafana user can create subdirectories",
